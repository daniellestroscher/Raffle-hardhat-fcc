 ...
 * @author Danielle Stroscher from tutorial by Patrick Collins
...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    constructor(
        uint256 entranceFee,
        address vrfCoordinatorV2, //need a mock contract
        bytes32 gasLane,
     ...
     * 2. Our players array should have at least one player and the contract should be funded with ETH.
